...
<div class="mb-3">
    ...
    $sql = "SELECT * FROM events WHERE etkinlik_tarih > NOW() ORDER BY etkinlik_tarih ASC";
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            echo "<img src='images/" . $row['etkinlik_id'] . "_etkinlik.jpg' width='300' alt='Etkinlik Görseli'>";
            echo "<div class='event-details'>";
            echo "<h2>" . $row['etkinlik_ad'] . "</h2>";
            echo "<p>" . $row['tanim'] . "</p>";
