...
<main>
    <section>
        <div class="card" style="background-color: #fff;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="images/yazılım_fuar.png" class="img-fluid rounded-start" alt="Yazılım Fuarı Görseli">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-body-secondary">Son güncelleme: 17 dakika önce</small></p>
                    </div>
                </div>
            </div>
        </div>
